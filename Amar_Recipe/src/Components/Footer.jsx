            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    <ul className="text-sm flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-5 mb-5 border-b border-gray-200">
                        ...
                        <li><a href="https://youtu.be/Cs7q1YvFoZs" target="_blank" rel="noopener noreferrer" className=" text-gray-800 hover:text-[#ff3300]">কিভাবে রেসিপি যোগ করবেন?</a></li>
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-5">
                        ...
                        <a href="https://www.instagram.com/shariful_islam10/" className="block  text-gray-900 transition-all duration-500 hover:text-[#ff3300] ">
                        ...
                        <a href="https://www.facebook.com/sharif.me2018/" className="block  text-gray-900 transition-all duration-500 hover:text-[#ff3300] ">
                        ...
                        <a href="https://www.youtube.com/@SHARIFsCODECORNER/" className="block  text-gray-900 transition-all duration-500 hover:text-[#ff3300] ">
