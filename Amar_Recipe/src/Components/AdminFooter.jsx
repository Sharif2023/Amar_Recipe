            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <a href="/Home" className="flex justify-center ">
                        <div className="text-black dark:text-white font-bold text-2xl mb-4 lg:mb-0 hover:text-orange-600 hover:cursor-pointer inline-flex items-center gap-2"><img src={logo} className="w-8 h-8" alt="Amar Recipe Header Logo" />আমার রেসিপি</div>
                    </a>
                    <ul className="text-sm flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-5 mb-5 border-b border-gray-200 dark:border-gray-800">
                        <li><a href="#" className=" text-gray-800 dark:text-gray-300 hover:text-[#ff3300]">রেসিপিগুলো দেখুন</a></li>
                        <li><a href="#" className=" text-gray-800 dark:text-gray-300 hover:text-[#ff3300]">নতুন রেসিপি যোগ করুন</a></li>
                        <li><a href="#" className=" text-gray-800 dark:text-gray-300 hover:text-[#ff3300]">ধরণ</a></li>
                        <li><a href="#" className=" text-gray-800 dark:text-gray-300 hover:text-[#ff3300]">আমাদের সম্পর্কে</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-5">
                        <a href="https://github.com/Sharif2023" className="block  text-gray-900 dark:text-white transition-all duration-500 hover:text-[#ff3300] ">
                            <svg
                            ...
                            >
                                <path
                                    fillRule="evenodd"
                                    d="M12 0C5.373 0 0 5.373 0 12c0 5.303 3.438 9.8 8.205 11.387.6.113.82-.26.82-.577 0-.285-.01-1.04-.015-2.04-3.338.726-4.042-1.61-4.042-1.61-.546-1.385-1.333-1.753-1.333-1.753-1.09-.745.083-.729.083-.729 1.205.085 1.84 1.237 1.84 1.237 1.07 1.835 2.807 1.305 3.492.997.107-.775.418-1.305.76-1.605-2.665-.304-5.467-1.334-5.467-5.933 0-1.31.467-2.38 1.235-3.22-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.3 1.23a11.5 11.5 0 0 1 3-.404c1.02.005 2.045.138 3 .404 2.29-1.552 3.296-1.23 3.296-1.23.653 1.652.242 2.873.118 3.176.77.84 1.233 1.91 1.233 3.22 0 4.61-2.807 5.625-5.48 5.922.43.372.823 1.102.823 2.222 0 1.606-.015 2.898-.015 3.293 0 .32.218.694.825.576C20.565 21.796 24 17.298 24 12c0-6.627-5.373-12-12-12z"
                                    clipRule="evenodd"
                                />
                            </svg>

                        </a>
                        <a href="https://www.instagram.com/shariful_islam10/" className="block  text-gray-900 dark:text-white transition-all duration-500 hover:text-[#ff3300] ">
                        ...
                        <a href="https://www.facebook.com/sharif.me2018/" className="block  text-gray-900 dark:text-white transition-all duration-500 hover:text-[#ff3300] ">
                        ...
                        <a href="https://www.youtube.com/@SHARIFsCODECORNER/" className="block  text-gray-900 dark:text-white transition-all duration-500 hover:text-[#ff3300] ">
