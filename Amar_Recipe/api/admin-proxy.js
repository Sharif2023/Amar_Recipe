// Vercel Serverless Function - Admin API Proxy to Bytehost
...
export default async function handler(req, res) {
    ...
    const BYTEHOST_ADMIN_API = 'https://amar-recipe.byethost7.com/admin_api';
    ...
    try {
        ...
        const url = new URL(`${BYTEHOST_ADMIN_API}/${endpoint}`);
